...
public final class AutoSizeCompat
{
     ...
     * {@link Resources}
     * @param customAdapt
     * {@link Activity} 或 Fragment 需实现 {@link CustomAdapt}
     */
     ...
     * @param resources
     * {@link Resources}
     * @param externalAdaptInfo
     * 三方库的 {@link Activity} 或 Fragment 提供的适配参数, 需要配合 {@link ExternalAdaptManager#addExternalAdaptInfoOfActivity(Class, ExternalAdaptInfo)}
     */
     ...
     * {@link Resources}
     * @param sizeInDp
     * 设计图上的设计尺寸, 单位 dp, 如果 {@param isBaseOnWidth} 设置为 {@code true},
     ...
     * @param scaledDensity
     * {@link DisplayMetrics#scaledDensity}
     * @param xdpi
     ...
     * {@link Resources}
     * @param screenWidthDp
     * {@link Configuration#screenWidthDp}
